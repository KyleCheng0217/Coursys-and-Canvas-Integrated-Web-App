...
(function() {
	...
	ScheduleTemplate.prototype.placeEvents = function() {
		...
		var self = this,
			slotHeight = this.topInfoElement.offsetHeight / 2;
		for(var i = 0; i < this.singleEvents.length; i++) {
			var anchor = this.singleEvents[i].getElementsByTagName('a')[0];
			var start = getScheduleTimestamp(anchor.getAttribute('data-offset')), duration = 120;
	...
	ScheduleTemplate.prototype.openModal = function(target) {
		...
		this.modalDate.textContent = 'Due at: '+target.getAttribute('data-due');
